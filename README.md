...
Проект вдохновлён комиксами, цветовым восприятием, спортивной статистикой и конструкторами LEGO.
...
```
src/
├── api/ # работа с API (fetch, TanStack Query)
...
├── views/ # страницы (Home, HeroPage, TeamPage)
├── App.vue
└── main.ts
```
